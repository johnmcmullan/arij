...
Why Tract uses modular skill structure with progressive disclosure.

This document explains Tract's design decisions for organizing documentation as skills with references.
