---
name: tract-timetracking
description: Log work hours and view timesheets in Tract. Use when logging time to a ticket, querying worklogs, or viewing a timesheet.
---
