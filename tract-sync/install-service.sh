...
echo "📍 Next Steps:"
echo ""
echo "1. Configure Jira webhook:"
echo "   URL: http://$(hostname):3000/webhook/jira"
echo "   Events: Issue created, updated; Comment created"
echo ""
echo "2. Developers can clone:"
echo "   git clone $(whoami)@$(hostname):$BARE_REPO"
echo ""
echo "3. Or as submodule in code repo:"
...
echo ""
echo "5. Test sync:"
echo "   # Edit ticket in Jira → should appear in git"
echo "   # Edit ticket in git → should appear in Jira"
echo ""
